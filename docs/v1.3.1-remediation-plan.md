...
### Upgrade Tests
- [ ] Upgrade from v1.0.0 → v1.3.1
- [ ] Upgrade from v1.1.0 → v1.3.1
- [ ] Upgrade from v1.2.0 → v1.3.1
- [ ] Upgrade from v1.2.1 → v1.3.1
- [ ] Upgrade from v1.2.2 → v1.3.1
- [ ] Upgrade from v1.3.0-rc1 → v1.3.1
...
| Release notes | `release_notes/v1.3.1.md` | TODO |
...
2. **Create v1.3.1-rc1 pre-release on `testing` branch**
3. **Request testers from Issues #5 and #6 to validate**
4. **Merge to `main` and tag v1.3.1 stable release**
