...
*This release includes all fixes from v1.2.1 and v1.2.2.*
...
### From v1.2.1 (Critical WiFi Safety Fix)
...
- **Fixed**: `--no-iwd` and `--use-iwd` flags removed (use OS tools instead).
...
### From v1.2.2 (Bandwidth Detection)
- **Note**: The speedtest approach from v1.2.2 has been **superseded** by instant Link Statistics in v1.3.0.
- The "160 mbps vs 970 mbps" regression fix is now handled by accurate link speed detection.
