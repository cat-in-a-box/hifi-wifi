...
**IMPORTANT: If upgrading from v1.2.x or earlier, run `sudo ./uninstall.sh` first, then reinstall with `sudo ./install.sh`. This ensures clean removal of deprecated components and prevents conflicts.**
